...
# Jira No       :  NSS-15895
# Gerrit Link   :
# Description   :  Remove duplicate entry from file
# Date          :  08/11/2017
        ...
        for sim_info in sim_data_list:
            ...
            if "LTE" in sim_name and "ERBS" in node_name:
                ...
                if os.path.isfile(eutrancell_data):
                    os.system("grep -E -v 'pERBS00.*\-1[0-9]|pERBS00.*\-[2-9]' '" + eutrancell_data + "' " + ' >> ' + EUTRANCELL_DATA_FILE )
                    os.system("grep -E -v 'pERBS00.*\-1[0-9]|pERBS00.*\-[2-9]' '" + eutrancell_data + "' " + ' >> ' + DEST_EUTRANCELL_DATA_FILE )
                else:
